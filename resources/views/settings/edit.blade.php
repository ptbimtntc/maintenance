        ...
        <form method="POST" action="{{ route('settings.update') }}">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Certificates with an expiry date within this many days are flagged "Expiring Soon" on the Dashboard, Certificates list, and employee profiles.</p>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Participants get an in-app notification this many days before a session starts.</p>
                    <x-input-error :messages="$errors->get('training_reminder_days_before')" class="mt-1" />
                </div>
            </div>

            <div class="mt-6 flex justify-end">
                <button type="submit" class="rounded-md bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800">Save Settings</button>
            </div>
        </form>
    </div>
</x-app-layout>

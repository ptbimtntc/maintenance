        ...
        <form method="POST" action="{{ $isEdit ? route('employees.development-plans.update', [$employee, $plan]) : route('employees.development-plans.store', $employee) }}">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select id="related_skill_id" name="related_skill_id" class="mt-1 block w-full rounded-md border-neutral-300 text-sm">
                        <option value="">—</option>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <select id="current_competency_level_id" name="current_competency_level_id" class="mt-1 block w-full rounded-md border-neutral-300 text-sm">
                            <option value="">—</option>
                    ...
                    <div>
                        ...
                        <select id="target_competency_level_id" name="target_competency_level_id" class="mt-1 block w-full rounded-md border-neutral-300 text-sm">
                            <option value="">—</option>
                            @foreach ($competencyLevels as $level)
                ...
                <div>
                    ...
                    <select id="development_action" name="development_action" class="mt-1 block w-full rounded-md border-neutral-300 text-sm">
                ...
                <div>
                    ...
                    <select id="recommended_training_program_id" name="recommended_training_program_id" class="mt-1 block w-full rounded-md border-neutral-300 text-sm">
                        <option value="">—</option>
                ...
                <div>
                    ...
                    <select id="mentor_employee_id" name="mentor_employee_id" class="mt-1 block w-full rounded-md border-neutral-300 text-sm">
                        <option value="">—</option>
                ...
                <div>
                    ...
                    <textarea id="manager_remarks" name="manager_remarks" rows="2" class="mt-1 block w-full rounded-md border-neutral-300 text-sm">{{ $old('manager_remarks') }}</textarea>
                </div>

                <div>
                    <x-input-label for="employee_remarks" value="Employee Remarks" />
                    <textarea id="employee_remarks" name="employee_remarks" rows="2" class="mt-1 block w-full rounded-md border-neutral-300 text-sm">{{ $old('employee_remarks') }}</textarea>
                </div>
            </div>

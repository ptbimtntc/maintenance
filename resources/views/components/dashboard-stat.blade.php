...
<div @class([
    'group relative flex flex-col rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all duration-150',
    ...
    <div class="flex items-start justify-between gap-3">
        <div class="min-w-0">
            <p class="text-sm font-medium leading-snug text-gray-500">{{ $label }}</p>
    ...
    @if ($href)
        <span class="relative mt-3 inline-flex items-center gap-1 text-xs font-medium text-slate-400 transition-colors group-hover:text-slate-600">
            View details

    ...
    <div class="max-w-3xl rounded-lg border border-neutral-200 bg-white p-6 shadow-md">
        <form method="POST" action="{{ $isEdit ? route('training.programs.update', $program) : route('training.programs.store') }}" enctype="multipart/form-data">
            ...
            <div class="mt-6 flex justify-end gap-2">
                <a href="{{ $isEdit ? route('training.programs.show', $program) : route('training.programs.index') }}" class="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium text-neutral-700 shadow-sm transition hover:bg-neutral-50">Cancel</a>
